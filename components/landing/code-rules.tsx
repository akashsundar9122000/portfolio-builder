...
const RULES = [
  ...
  { icon: Download, title: "Build, download, publish", body: "While your code is valid, edit, preview, download the ZIP or single HTML, and publish your site to its own link — as often as you like. A published site stays online after your code expires, until you unpublish it." },
